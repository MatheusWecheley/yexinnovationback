...
export class ClientRepo implements IClientRepo {
  ...
  async clients(first: number, after: string, filter: Partial<Client>): Promise<Client[]> {
    throw new Error("Method not implemented");
  }

  async updateClient(id: string, fieldsToUpdate: Partial<Client>): Promise<boolean> {
